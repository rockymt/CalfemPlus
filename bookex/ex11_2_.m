...
fr=sparse(Egv(:,base+1:base+nev)'*f);
% ----- reduced system matrices ---------------------------------
kr=Egv(:,base+1:base+nev)'*K*Egv(:,base+1:base+nev);
mr=Egv(:,base+1:base+nev)'*M*Egv(:,base+1:base+nev);
% ----- initial condition ---------------------------------------
...
DsnapR=Egv(:,base+1:base+nev)*Dsnapr;
DR=Egv(nhist,base+1:base+nev)*Dr;
