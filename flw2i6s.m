function [es,et,eci]=flw2i6s(ex,ey,ep,D,ed)
% [es,et,eci]=flw2i6s(ex,ey,ep,D,ed)
%-------------------------------------------------------------
% PURPOSE
%  Compute flows or corresponding quantities in the
%  6 node isoparametric field element.
%
% INPUT:  ex = [x1 x2 x3.... x6]   element coordinates
%         ey = [y1 y2 y3.... y6]
%                             
