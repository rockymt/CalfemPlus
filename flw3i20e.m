function [Ke,fe]=flw3i20e(ex,ey,ez,ep,D,eq)
% Ke=flw3i20e(ex,ey,ez,ep,D)
% [Ke,fe]=flw3i20e(ex,ey,ez,ep,D,eq)
%-------------------------------------------------------------
% PURPOSE
%  Compute element stiffness (conductivity)
%  matrix for 20 node isoparametric field element
...
%    
  ...
  Ke1=zeros(20,20);  fe1=zeros(20,1);
  JT=dNr*[ex;ey;ez]';
