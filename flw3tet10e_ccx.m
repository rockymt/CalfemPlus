function [Ke,fe]=flw3tet10e_ccx(ex,ey,ez,ep,D,eq)
% Ke=flw3tet10e_ccx(ex,ey,ez,ep,D)
% [Ke,fe]=flw3tet10e_ccx(ex,ey,ez,ep,D,eq)
%-------------------------------------------------------------
% PURPOSE
...
%                                       volume  
%
% OUTPUT: Ke : element stiffness matrix (10 x 10)
%
%         fe : element load vector (10 x 1)
%-------------------------------------------------------------
