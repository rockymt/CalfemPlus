  function [es,et,eci]=soli20s(ex,ey,ez,ep,D,ed)
% [es,et,eci]=soli20s(ex,ey,ez,ep,D,ed)
%-------------------------------------------------------------
% PURPOSE
%  Calculate element normal and shear stress for a
%  20 node (brick) isoparametric element.
...
%
%         ed = [u1 u2 ..u60;      element displacement vector
