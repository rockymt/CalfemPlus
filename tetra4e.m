  function [Ke,fe]=tetra4e(ex,ey,ez,D,eq)
% Ke=tetra4e(ex,ey,ey,D)
% [Ke,fe]=tetra4e(ex,ey,ey,D,eq)
%-------------------------------------------------------------
% PURPOSE
%  Calculate the stiffness matrix for a 4 node (tetra) element.
%
...
%------------------------------------------------------------- 
  ...
  Ke=detJ/6.0*B'*D*B;
  fe=detJ/24.0*[bx by bz bx by bz...
                bx by bz bx by bz]';
  end
%--------------------------end--------------------------------  
